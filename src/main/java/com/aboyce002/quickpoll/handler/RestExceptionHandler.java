package com.aboyce002.quickpoll.handler;
...
import com.aboyce002.quickpoll.dto.error.ValidationError;
...
import com.aboyce002.quickpoll.dto.error.ErrorDetail;
    ...
    public ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        for(FieldError fe : fieldErrors) {
            List<ValidationError> validationErrorList = errorDetail.getErrors().
                    computeIfAbsent(fe.getField(), k -> new ArrayList<ValidationError>());
